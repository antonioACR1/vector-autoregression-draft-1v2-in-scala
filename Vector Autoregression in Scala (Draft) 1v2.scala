...
/*val newExogen=Option(Array(Array(20.0,40.0),Array(21.0,41.0),Array(22.0,42.0),Array(23.0,43.0),Array(24.0,44.0)))
val nAheadNew=5*/

class predict(newExogen:Option[Array[Array[Double]]],nAheadNew:Int) extends varModel(df: Array[Array[Double]], exogen: Option[Array[Array[Double]]], interceptTrend: Option[String], criteria: String, p: Int, maxLag: Option[Int], season: Option[Int]){
def unionOriginalAndForecast(dfArr:Array[Array[Double]],forecast:Array[Double]):Array[Array[Double]]={
  val dfArrayUnion=dfArr:+forecast
  dfArrayUnion
}
  val modelo=new varModel(df: Array[Array[Double]], exogen: Option[Array[Array[Double]]], interceptTrend: Option[String], criteria: String, p: Int, maxLag: Option[Int], season: Option[Int])
  val coeff=modelo.matrix
  val newExogenChoice=newExogen.getOrElse(Array(Array(0.0)))
  /*construction of Zdet*/
  val trdstart = nObs+1
  var ZdetDMPredict=RHS(interceptTrendChoice,trdstart,nAheadNew)
